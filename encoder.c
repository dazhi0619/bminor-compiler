...
int hex2dec(const char *s, int *ret) {
  ...
  int hex_table[128];
  for (int i = 0; i < 128; i++) hex_table[i] = -1;
  for (int i = 48; i < 58; i++) {
    hex_table[i] = i - 48;
  }
  for (int i = 65; i < 71; i++) {
...
int escape(const char *s, char *ret) {
  ...
  int convert_table[128];
  for (int i = 0; i < 128; i++) convert_table[i] = -1;
  convert_table['a'] = 7;
  convert_table['b'] = 8;
  convert_table['e'] = 27;
  convert_table['f'] = 12;
...
int reverse_escape(const char *s, char *ret) {
  char convert_table[128];
  for (int i = 0; i < 128; i++) convert_table[i] = 0;
  convert_table[7] = 'a';
  convert_table[8] = 'b';
  convert_table[27] = 'e';
  convert_table[12] = 'f';
