...
{
       0,   105,   105,   106,   109,   110,   113,   114,   115,   118,
     119,   122,   123,   126,   127,   130,   131,   134,   135,   136,
     137,   138,   139,   140,   143,   145,   147,   148,   151,   152,
     155,   156,   159,   161,   162,   165,   166,   167,   168,   169,
     170,   171,   172,   173,   176,   177,   178,   179,   180,   181,
     182,   183,   186,   187,   190,   191,   194,   195,   198,   199,
     202,   203,   206,   207,   210,   211,   212,   213,   214,   215,
     216,   219,   220,   221,   224,   225,   226,   227,   230,   231,
     234,   235,   236,   237,   240,   241,   242,   245,   246,   247,
...
static const char *const yytname[] =
{
  ...
  "TOKEN_STRING", "TOKEN_ARRAY", "TOKEN_AUTO", "TOKEN_BOOL", "TOKEN_TRUE",
  "TOKEN_FALSE", "TOKEN_VOID", "TOKEN_IF", "TOKEN_ELSE", "TOKEN_FOR",
  "TOKEN_FUNCTION", "TOKEN_PRINT", "TOKEN_RETURN", "TOKEN_WHILE",
  "TOKEN_LPAREN", "TOKEN_RPAREN", "TOKEN_LBRACKET", "TOKEN_RBRACKET",
  "TOKEN_INCRE", "TOKEN_DECRE", "TOKEN_NOT", "TOKEN_EXP", "TOKEN_MINUS",
  "TOKEN_DIV", "TOKEN_MOD", "TOKEN_PLUS", "TOKEN_MUL", "TOKEN_LT",
  "TOKEN_LE", "TOKEN_GT", "TOKEN_GE", "TOKEN_EQ", "TOKEN_NE", "TOKEN_AND",
  "TOKEN_OR", "TOKEN_ASSIGN", "TOKEN_LBRACE", "TOKEN_RBRACE", "TOKEN_SEMI",
  "TOKEN_COMMA", "TOKEN_COLON", "TOKEN_INT_LITERAL", "TOKEN_FLOAT_LITERAL",
  "TOKEN_STRING_LITERAL", "TOKEN_CHAR_LITERAL", "TOKEN_IDENT", "$accept",
  "program", "decl", "optinit", "arrliteral", "arrliterallst", "block",
  "type", "simpletype", "arrtype", "functype", "optfuncinit", "paramlist",
  "paramtype", "arrparam", "optparam", "stmt", "innerstmt", "arrlst",
  "exprlst", "optexpr", "expr", "rightval", "or_operand", "and_operand",
  "compared", "term", "exponent", "multiplier", "factor", "value",
  "optarrvalue", YY_NULLPTR
};
#endif
...
{
     -19,    -5,    66,   -19,   160,  -148,  -148,  -148,  -148,  -148,
    -148,    40,  -148,  -148,  -148,   384,    37,  -148,  -148,   335,
      50,    42,   232,  -148,  -148,  -148,  -148,   335,    82,    82,
      82,  -148,  -148,  -148,  -148,    34,    48,    43,    54,    49,
      13,    -7,    35,    71,  -148,  -148,    12,    45,    73,  -148,
    -148,   232,    75,    62,   -13,  -148,  -148,  -148,   265,   335,
     384,   335,   335,   335,   335,   335,   335,   335,   335,   335,
     335,   335,   335,   335,   335,   335,  -148,  -148,    77,    96,
      94,    83,   -26,  -148,  -148,  -148,  -148,   -11,     3,  -148,
      54,    49,    13,    -7,    -7,    -7,    -7,    -7,    -7,    35,
      35,    71,    71,    71,  -148,   394,  -148,   107,   119,   277,
      44,    43,    57,    71,    70,    22,    23,    51,    21,    44,
      44,    73,    65,    46,    13,    15,    17,    18,    42,    54,
      68,    69,    73,    72,    23,    65,    20,    20,    44,    73,
      72,    58,    14,    44,    44,    67,    73,    72,    70,    44,
      43,    13,    15,    17,    18,    42,    54,    69,    73,    72,
      21,    44,    44,    20,    20,    44,    73,    72,    58,    44,
      21,    69,    72,    73,    72,    70,    44,    43,    68,    14,
      44,    21,    44,    44,    69,    72,    69,    72,    21,    14,
      44,    69,    69,    72,    21
};
...
#line 105 "parser.bison" /* yacc.c:1646  */
    { (yyvsp[-1].decl)->next = (yyvsp[0].decl); root = (yyvsp[-1].decl); }
#line 1481 "parser.c" /* yacc.c:1646  */
    break;

  case 3:
#line 106 "parser.bison" /* yacc.c:1646  */
    { (yyval.decl) = NULL; root = NULL; }
#line 1487 "parser.c" /* yacc.c:1646  */
    break;

  case 4:
#line 109 "parser.bison" /* yacc.c:1646  */
    { (yyval.decl) = decl_create((yyvsp[-3].string), (yyvsp[-1].type), (yyvsp[0].expr), NULL, NULL); }
#line 1493 "parser.c" /* yacc.c:1646  */
    break;

  case 5:
#line 110 "parser.bison" /* yacc.c:1646  */
    { (yyval.decl) = decl_create((yyvsp[-4].string), (yyvsp[-1].type), NULL, (yyvsp[0].stmt), NULL); }
...
#line 118 "parser.bison" /* yacc.c:1646  */
    { struct expr* head = expr_create(EXPR_LIST, (yyvsp[-2].expr), (yyvsp[-1].expr)); (yyval.expr) = expr_create(EXPR_LIST, NULL, head); }
...
#line 143 "parser.bison" /* yacc.c:1646  */
    { (yyval.type) = type_create(TYPE_ARRAY, (yyvsp[0].type), NULL); (yyval.type)->arr_len = (yyvsp[-2].expr); }
...
#line 151 "parser.bison" /* yacc.c:1646  */
    { (yyval.param_list) = param_list_create((yyvsp[-3].string), (yyvsp[-1].type), (yyvsp[0].param_list)); }
...
#line 169 "parser.bison" /* yacc.c:1646  */
    { struct expr* lst = expr_create(EXPR_ARG, (yyvsp[-2].expr), (yyvsp[-1].expr)); (yyval.stmt) = stmt_create(STMT_PRINT, NULL, NULL, lst, NULL, NULL, NULL, NULL); }
...
#line 246 "parser.bison" /* yacc.c:1646  */
    { struct expr* name = expr_create_name((yyvsp[-4].string)); struct expr* args = expr_create(EXPR_ARG, (yyvsp[-2].expr), (yyvsp[-1].expr)); (yyval.expr) = expr_create(EXPR_CALL, name, args); }
#line 1997 "parser.c" /* yacc.c:1646  */
    break;

  case 89:
#line 247 "parser.bison" /* yacc.c:1646  */
    { struct expr* name = expr_create_name((yyvsp[-2].string)); (yyval.expr) = expr_create(EXPR_CALL, name, NULL); }
...
#line 254 "parser.bison" /* yacc.c:1646  */
    { struct expr* name = expr_create_name((yyvsp[-4].string)); (yyvsp[-2].expr)->right = (yyvsp[0].expr); (yyval.expr) = expr_create(EXPR_SUBSCRIPT, name, (yyvsp[-2].expr)); }
...
#line 258 "parser.bison" /* yacc.c:1646  */
    { (yyvsp[-1].expr)->right = (yyvsp[-3].expr); (yyval.expr) = (yyvsp[-1].expr); }
